    ...
    return (
        <div className="fixed inset-0 flex flex-col bg-[#ffffff] z-9999 overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-50">
                ...
                <div ref={wordRef} className="flex items-center justify-center w-xl sm:w-auto z-50 absolute lg:top-100 top-55 lg:translate-y-0 translate-y-full" style={{ opacity: 0 }}>
